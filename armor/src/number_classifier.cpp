...
namespace rm_auto_aim
{
    ...
    {
        // std::string pkg_path = "/home/ovalene/infantry_7_25";
        auto my_model_path = "/home/csy/Desktop/RM/infantry_9_28/model/mlp.onnx";
        this->net_ = cv::dnn::readNetFromONNX(my_model_path);

        std::ifstream label_file("/home/csy/Desktop/RM/infantry_9_28/model/label.txt");
        std::string line;
    ...
    void NumberClassifier::classify(std::vector<Armor> &armors)
    {
        for (auto &armor : armors)
        {
            ...
            // std::string model_structure = net_.dump();

            // Forward pass the image blob through the model
            cv::Mat outputs = this->net_.forward();
