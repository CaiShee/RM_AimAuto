...
{
    points3d.push_back(cv::Point3f(translator.message.x_c, translator.message.y_c, translator.message.vx_c));
    if (points3d.size() >= 70)
    {
        draw(points3d, times, 1, 200, 0.03);
        draw(points3d, times, 2, 200, 0.03);
        draw(points3d, times, 3, 200, 0.15);
